...
закомментировал строки отвечающие за id облака id папки и за ключ

![](img/img-04-02.png)

все работает, т.к. я изначально настраивал среду и YC по документации YC

![](img/img-04-03.png)

и переменные у меня инициализируются в .bashrc
